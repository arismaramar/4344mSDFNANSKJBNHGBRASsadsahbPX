...
echo ""
echo -e "Script EXP COK! ${red}NOT REGISTER${NC} @ ${red}EXPIRED${NC}"
echo ""
...
MYIP=$(wget -qO- ipv4.icanhazip.com);
Name=$(curl -sS https://raw.githubusercontent.com/lunoxximpostor/4344mSDFNANSKJBNHGBRASsadsahbPX/main/accesss | grep $MYIP | awk '{print $4}')
